...
function App(){
 const [projects,setProjects]=useState([]),[projectId,setProjectId]=useState(null),[project,setProject]=useState(null),[projectEvidenceSummary,setProjectEvidenceSummary]=useState(null);
