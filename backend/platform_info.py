...
VERSION_HISTORY = [
    ...
    },
    {
        "version": "v4.8.1",
        "release_date": "2026-09-02",
        "stage": "Scientific routing milestone",
...
PREDICTION_MODEL_HISTORY: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "production_status": "CURRENT_PRODUCTION_DEFAULT",
        "decision": "REPLACE_V3_3_1_CONFIRMED",
    ...
    },
    {
        ...
        "decision": "CANDIDATE_READY_FOR_EVALUATION",
        "key_endpoints": "PK Critical Upgrade & DrugBank 250 (11 validated endpoints + Canonical PK Parameter Layer: fu physical bound, Well-Stirred IVIVE, 1-Compartment PK Simulation); Model Unavailable (3 endpoints: CYP2C19, P-gp, BCRP). DrugBank 250 approved reference drugs (100% collision-free CAS, UNII, InChIKey).",
        "validation_results": "Clinical benchmark drugs (APAP, Osimertinib, Sunvozertinib, Metformin, Warfarin, Midazolam) evaluated with AAFE 2.20-fold, 61.1% within 2-fold, and 77.8% within 3-fold. 15 internal pipeline compounds across GLP-1, EGFR, AMYR simulated with 100% mathematical validity. Formal PK_CRITICAL_GATE status: PASS_WITH_LIMITATIONS.",
        "model_version_hash": "2ba75ad8813cafd84173369dfbda8abd4190789c16f52f90a905750e620e43d2",
