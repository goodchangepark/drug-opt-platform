...
REGISTRY: dict[str, CanonicalEndpoint] = {
    ...
    # Existing user-entered percent-remaining assays are not Clint values.  These
    # canonical identities preserve that distinction without creating a model
    # route or silently converting assay semantics.
    "HUMAN_MICROSOMAL_STABILITY_PERCENT_REMAINING": _ep("HUMAN_MICROSOMAL_STABILITY_PERCENT_REMAINING", "METABOLISM", "Human microsomal stability (% remaining)", "parent compound remaining in human liver microsomes at the recorded assay time", "numeric", "%", "PERCENT", domain="clearance", species_requirement="HUMAN", matrix_requirement="microsomes", assay_requirement="percent remaining"),
    "RAT_MICROSOMAL_STABILITY_PERCENT_REMAINING": _ep("RAT_MICROSOMAL_STABILITY_PERCENT_REMAINING", "METABOLISM", "Rat microsomal stability (% remaining)", "parent compound remaining in rat liver microsomes at the recorded assay time", "numeric", "%", "PERCENT", domain="clearance", species_requirement="RAT", matrix_requirement="microsomes", assay_requirement="percent remaining"),
    ...
    "HUMAN_PK_CMAX_UNSPECIFIED": _ep("HUMAN_PK_CMAX_UNSPECIFIED", "PK", "Human Cmax (context incomplete)", "maximum observed human plasma concentration where route or formulation is unresolved", "numeric", "ng/mL", "LINEAR", domain="pharmacokinetics", species_requirement="HUMAN"),
