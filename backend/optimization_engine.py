...
TRANSFORMATION_LIBRARY = (
    ...
    _t("MET_N_DEALK_BLOCK", "Block N-dealkylation handle", "[N:1][CH2;H2:2]>>[N:1][CH:2](F)", "Metabolism", "[N][CH2]", "May reduce N-dealkylation at the adjacent carbon", "Basicity and off-target profile can change", METABOLISM_SOURCE, ["metabolic_stability", "metabolic_soft_spot"], ["Improve metabolic stability"]),
    _t("MET_O_DEALK_BLOCK", "Block O-dealkylation handle", "[O:1][CH2;H2:2]>>[O:1][CH:2](F)", "Metabolism", "[O][CH2]", "May reduce O-dealkylation at the adjacent carbon", "May redirect metabolism or alter potency", METABOLISM_SOURCE, ["metabolic_stability", "metabolic_soft_spot"], ["Improve metabolic stability"]),
