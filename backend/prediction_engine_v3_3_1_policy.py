...
ENGINE_V3_1_STATUS = "PRODUCTION_DEFAULT"
...
V3_3_1_ENDPOINT_ROUTING: Dict[str, Dict[str, Any]] = {
    ...
    "CYP1A2_INHIBITION": {
        ...
        "locked_test_n": 5,
        "ad_status": "IN_DOMAIN_WITH_GUARD",
        "production_decision": "V3_3_1_BEST_SINGLE",
    },
    "CYP2C9_INHIBITION": {
    ...
    "SOLUBILITY_GENERIC": {
        ...
        "improvement_vs_v3_3_pct": 4.9,
        "validation_n": 35,
        "locked_test_n": 13,
        "ad_status": "IN_DOMAIN",
        "production_decision": "V3_3_1_WEIGHTED_ENSEMBLE",
    },
    "CACO2_PERMEABILITY": {
    ...
    "HERG_LIABILITY": {
        ...
        "unit": "pIC50",
        "tier": "GLOBAL_V3_PRIMARY",
        "display_model": "Best Single Model (Physchem GBR Regressor)",
        "algorithm": "BEST_SINGLE_MODEL_ROUTE",
